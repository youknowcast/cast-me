...
puts "✓ ユーザーを作成: #{user1.login_id}, #{user2.login_id}, #{user3.login_id}, #{user4.login_id}"
...
puts "ログイン情報:"
puts "  ユーザーID: father, mother, child1, child2"
